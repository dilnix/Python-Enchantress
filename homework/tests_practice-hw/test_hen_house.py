...
class TestHenHouse(unittest.TestCase):
    ...
    def test_h_get_eggs_daily_in_winter(self):
        ...
        with patch.object(HenHouse, "season", "winter"):
            self.assertEqual(self.hen_house.get_eggs_daily(
                self.hen_house.hen_count), 4)
    ...
    def test_i_get_max_count_for_soup(self):
        ...
        with patch.object(HenHouse, "season", "autumn"):
            self.assertEqual(self.hen_house.get_max_count_for_soup(4), 8)
    ...
    def test_j_get_max_count_for_soup_returns_zero(self):
        ...
        with patch.object(HenHouse, "season", "summer"):
            self.assertEqual(self.hen_house.get_max_count_for_soup(20), 0)
    ...
    def test_k_food_price(self):
        ...
        with patch("requests.get") as mocked:
            ...
            mocked.return_value.text = '11111111111111111'
